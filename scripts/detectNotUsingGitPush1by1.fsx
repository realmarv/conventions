...
let prCommits =
    ...
    Console.WriteLine $"Pull request commits URL is: {url}"
...
Console.WriteLine $"Pull request commits are: {prCommits}"
...
let hasCiStatus =
    ...
    |> Seq.map(fun commit ->
        ...
        Console.WriteLine $"{commit} check suites: {json}"
...
|> Seq.iter(fun commit ->
    ...
    if
        ...
        && not(commitMessageTitle.Contains "failing test")
    then
        Console.Error.WriteLine
