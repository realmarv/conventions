...
export abstract class Plugins {
    ...
    public static headerMaxLengthWithSuggestions(headerStr: string, maxLineLength: number) {
        let offence = false;
    ...
    public static bodySoftMaxLineLength(rawStr: string, bodyMaxLineLength: number) {
        let offence = false;
