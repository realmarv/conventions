...
test('replacement-suggestion1', () => {
    ...
    let expected_message = `We recommend replacing "configuration" with "config" in the commit title to make it shorter.`
...
test('replacement-suggestion2', () => {
    ...
    let expected_message = `We recommend replacing "absolute" with "abs" in the commit title to make it shorter.`
    // console.log('HERE ==========>' + replacementSuggestion1.stdout)
